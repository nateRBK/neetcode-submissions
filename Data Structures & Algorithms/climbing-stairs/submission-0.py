class Solution:
    def climbStairs(self, n: int) -> int:
        ...
        #probably need to divide out k! options:
        #(n-k)!/k!(n-2k)!
        #so then the answer would be the sum of k from 0 to n/2. on n = 3:
        #(3-0)!/(0)!(3-0)! + (3-1)!/(1)!(3-2)!
        #3!/3! + 2! = 3. approved. will have to specify for odds that the 
        #upper limit is (n+1)/2
        sum = 0
